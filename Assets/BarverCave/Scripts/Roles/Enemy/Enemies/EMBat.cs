...
public class EMBat : RoleAnimController {
	...
	public override void loadanimation (ns_predefine.ModelEnum _type)
	{
		...
		Dictionary<ModelEnum,string[]> _anim = new Dictionary<ModelEnum, string[]> (){ 
			...
			{ModelEnum.Run,new string[]{"FlyForward","Fly Forward"}},
			{ModelEnum.Die,new string[]{"Die","Die"}},
			{ModelEnum.Atk_Normal_0,new string[]{"BiteAttack","Bite Attack"}},
			{ModelEnum.Atk_Normal_1,new string[]{"BiteAttack","Bite Attack"}},
			{ModelEnum.Atk_Skill_0,new string[]{"SoundwaveAttack Cast(Loop)","Soundwave Attack"}},
		...
		_AnimEv = new Dictionary<int, roleanimev> (){
			...
			{Animator.StringToHash(_AnimParam[ModelEnum.Atk_Skill_1]._animname),new roleanimev(_AnimParam[ModelEnum.Atk_Skill_1],0.0f,0.3f,0.4f,0.94f)},
		};
	}
	...
	public override void doanim (ModelEnum _anim)
	{
		...
		if (_Preanim == ModelEnum.Atk_Skill_0) {
			if (_anim != ModelEnum.Atk_Skill_0)
