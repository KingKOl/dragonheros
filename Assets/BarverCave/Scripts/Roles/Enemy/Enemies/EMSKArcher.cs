...
public class EMSKArcher : RoleAnimController {
	...
	public override void loadanimation (ns_predefine.ModelEnum _type)
	{
		...
		Dictionary<ModelEnum,string[]> _anim = new Dictionary<ModelEnum, string[]> (){ 
			...
			{ModelEnum.Atk_Normal_0,new string[]{"ArrowAttack","Arrow Attack"}},
			{ModelEnum.Atk_Normal_1,new string[]{"MultipleShotsAttack","Multiple Shots Attack"}},
