...
public class EMSKMage : RoleAnimController {
	...
	public override void loadanimation (ns_predefine.ModelEnum _type)
	{
		...
		Dictionary<ModelEnum,string[]> _anim = new Dictionary<ModelEnum, string[]> (){ 
			...
			{ModelEnum.Atk_Normal_0,new string[]{"MeleeAttack","Melee Attack"}},
			{ModelEnum.Atk_Normal_1,new string[]{"ProjectileAttack","Projectile Attack"}},
			{ModelEnum.Atk_Skill_0,new string[]{"ProjectileAttack","Projectile Attack"}},
