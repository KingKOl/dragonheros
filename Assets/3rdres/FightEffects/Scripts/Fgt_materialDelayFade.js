...
function Start ()
{
    ...
    maxAlpha=myColor.a;
    _renender.material.SetColor ("_TintColor", Color(myColor.r, myColor.g, myColor.b,0));
...
function Update () {
    ...
    if (delayTime>delay)
    {
        ...
        {
            percent=(timeElapsed/fadeInTime) * maxAlpha;
            _renender.material.SetColor ("_TintColor", Color(myColor.r, myColor.g, myColor.b, percent));
        }
			
        if((timeElapsed>fadeInTime)&&(timeElapsed<fadeInTime+stayTime)) //set the normal color
        {
            _renender.material.SetColor ("_TintColor", Color(myColor.r, myColor.g, myColor.b, maxAlpha));
        }
